...
{
	public class Vector2Frame(Vector2 start, Vector2 end, BezierCurve bezierCurve)
	{
		public Vector2 Start { get; private set; } = start;
		public Vector2 End   { get; private set; } = end;
